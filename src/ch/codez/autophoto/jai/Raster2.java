...
public class Raster2 extends Raster {
     ...
     * parameters.
     */
    public Raster2(SampleModel sampleModel, DataBuffer dataBuffer, Rectangle aRegion,
    ...
    /**
     * returns the pixel value in band 0 at position west of the given position,
    ...
    /**
     * returns the pixel value in band 0 at position east of the given position,
     * if it exists, otherwise returns -1.
     * 
     * @param u horizontal raster position.
     * @param v vertical raster position.
    ...
    /**
     * returns the covariance between the pixel values in bands 0 and 1 (red,
     * green).
     * 
    ...
    /**
     * returns the covariance between the pixel values in bands 1 and 2 (blue,
     * green).
     * 
    ...
    /**
     * returns the covariance between the pixel values in bands 0 and 2 (red,
     * blue).
     * 
